...
fn set_config(map: &PathMap, extra: &mut McStateExtra, config: ConfigParamEnum) -> Result<()> {
    extra.config.set_config(config)
...
pub fn parse_state(map: &Map<String, Value>) -> Result<ShardStateUnsplit> {
    ...
    set_config(&config, &mut extra, ConfigParamEnum::ConfigParam0(ConfigParam0 {config_addr} ))?;
    let elector_addr = config.get_uint256("p1")?;
    set_config(&config, &mut extra, ConfigParamEnum::ConfigParam1(ConfigParam1 {elector_addr} ))?;
    ...
    set_config(&config, &mut extra, ConfigParamEnum::ConfigParam9(ConfigParam9 {mandatory_params} ))?;
    ...
    set_config(&config, &mut extra, ConfigParamEnum::ConfigParam10(ConfigParam10 {critical_params} ))?;
    ...
    set_config(&config, &mut extra, ConfigParamEnum::ConfigParam11(p11))?;
    ...
    set_config(&config, &mut extra, ConfigParamEnum::ConfigParam14(ConfigParam14 {block_create_fees}))?;
    ...
    set_config(&config, &mut extra, ConfigParamEnum::ConfigParam15(p15))?;
    ...
    set_config(&config, &mut extra, ConfigParamEnum::ConfigParam16(p16))?;
    ...
    set_config(&config, &mut extra, ConfigParamEnum::ConfigParam17(p17))?;
    ...
    set_config(&config, &mut extra, ConfigParamEnum::ConfigParam20(p20))?;
    ...
    set_config(&config, &mut extra, ConfigParamEnum::ConfigParam21(p21))?;

    let p22 = parse_block_limits(&config.get_obj("p22")?)?;
    set_config(&config, &mut extra, ConfigParamEnum::ConfigParam22(p22))?;

    let p23 = parse_block_limits(&config.get_obj("p23")?)?;
    set_config(&config, &mut extra, ConfigParamEnum::ConfigParam23(p23))?;
    
    let p24 = parse_msg_forward_prices(&config.get_obj("p24")?)?;
    set_config(&config, &mut extra, ConfigParamEnum::ConfigParam24(p24))?;

    let p25 = parse_msg_forward_prices(&config.get_obj("p25")?)?;
    set_config(&config, &mut extra, ConfigParamEnum::ConfigParam25(p25))?;
    ...
    set_config(&config, &mut extra, ConfigParamEnum::ConfigParam28(p28))?;
    ...
    set_config(&config, &mut extra, ConfigParamEnum::ConfigParam29(ConfigParam29 {consensus_config}))?;
    ...
    set_config(&config, &mut extra, ConfigParamEnum::ConfigParam34(ConfigParam34 {cur_validators}))?;
